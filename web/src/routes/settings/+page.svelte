				...
				<div class="card overflow-hidden">
					<ul class="divide-y divide-secondary-200">
						{#each tabs as tab (tab.id)}
							<li>
								<button
									class="flex w-full items-center gap-3 px-4 py-3 text-left transition-colors {activeTab ===
									tab.id
						...
						<div class="mt-6 space-y-6">
										...
										<div class="grid gap-4 sm:grid-cols-2">
											<div>
												<span
													...
													>Username</span
												>
												<p class="mt-1 text-secondary-900">
											...
											<div>
												<span
													...
													>Role</span
												>
												<p class="mt-1 text-secondary-900 capitalize">
													{authStore.user.role}
												</p>
											</div>
							...
							<div class="border-b border-secondary-200 pb-6">
								...
								<div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
									<div class="rounded-lg bg-secondary-50 p-4">
										...
										<div class="mt-1 font-mono text-secondary-900">
											localhost:1025
										</div>
									</div>
									<div class="rounded-lg bg-secondary-50 p-4">
							...
							<div>
								...
								<div class="mt-4 space-y-3">
									<button class="btn-danger"> Delete All Messages </button>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card p-6">
								<div class="flex items-center justify-between mb-6">
									<div>
										...
										<p class="mt-1 text-sm text-secondary-500">
											Configure webhooks to receive notifications when events
											occur.
										</p>
									</div>
									<button class="btn-primary" onclick={() => openWebhookForm()}>
										<svg
											class="mr-2 h-4 w-4"
											fill="none"
											viewBox="0 0 24 24"
